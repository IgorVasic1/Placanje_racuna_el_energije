...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    NewCustomer(){
        ...
        JLabel title = new JLabel("Novi klijent");
        ...
        p.add(l1);
        p.add(t1);
        l2 = new JLabel("ID Brojila");
        l2.setBounds(100, 120, 100, 20);
        l11 = new JLabel();
        l11.setBounds(240, 120, 200, 20);
        p.add(l2);
        p.add(l11);
        l3 = new JLabel("Adresa stanovanja");
        ...
        l6 = new JLabel("Elektronska pošta");
        l6.setBounds(100, 280, 100, 20);
        t6 = new JTextField();
        t6.setBounds(240, 280, 200, 20);
        p.add(l6);
        p.add(t6);
        l7 = new JLabel("Broj telefona");
        ...
        b1 = new JButton("Nastavi");
        b1.setBounds(100, 390, 150, 20);
        b2 = new JButton("Otkaži");
        b2.setBounds(290, 390, 150, 20);
        ...
        Image i3 = ic1.getImage().getScaledInstance(190, 300,Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null,"Podatci o klijentu dodani uspješno");
