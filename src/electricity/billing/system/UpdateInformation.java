...
public class UpdateInformation extends JFrame implements ActionListener {
    ...
    UpdateInformation(String meter){
        ...
        JLabel heading = new JLabel("AŽURIRAJ INFORMACIJE O POTROŠAČU");
        ...
        JLabel lbladdress = new JLabel("Adresa stanovanja");
        ...
        JLabel lblstate = new JLabel("Država");
        ...
        cancel.setBounds(30, 340, 150, 25);
        add(cancel);
        cancel.addActionListener(this);
        
        update = new JButton("Ažuriraj");
        update.setBounds(230, 340, 150, 25);
        add(update);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == update){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null,"Informacije uspješno ažurirane");
                setVisible(true);
            }catch(Exception e){
                e.printStackTrace();
            }
